class ResidenceModel {
  ...
  ResidenceModel.fromJson(dynamic json) {
    _status = json['status'];
...
class Attributes {
  ...
  Attributes.fromJson(dynamic json) {
    _residences = json['residences'] != null ? Residences.fromJson(json['residences']) : null;
  }
  Residences? _residences;

  Residences? get residences => _residences;

  Map<String, dynamic> toJson() {
    final map = <String, dynamic>{};
    if (_residences != null) {
      map['residences'] = _residences?.toJson();
    }
    return map;
  }
